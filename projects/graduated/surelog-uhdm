...
brief_summary: SureLog is a SystemVerilog 2017 Pre-processor, Parser, UHDM Compiler providing IEEE Design/TB VPI and Python AST API. UHDM is the underlying Hardware Data Model framework. More info: https://woset-workshop.github.io/WOSET2020.html#article-10
# The project's open source license, normally Apache 2.0 unless special exception is granted
license: Apache 2.0
# Link to issue tracker
issue_tracker_link: https://github.com/chipsalliance/Surelog/issues
# Link to website
website_link: N/A
...
project_usage_and_scale: Google, Antmicro
# Project's motivation to join CHIPS
why_join_chips: The projects joined CHIPS Alliance in order to build a community around UHDM and Surelog, to grow the userbase and attract additional contributions, improve SystemVerilog support in open source tools.
...
primary_contact:
  ...
  github_handle: alaindargelas
  # Contact's role in the project
  project_role: Maintainer, core contributor
...
active_committers: https://github.com/chipsalliance/Surelog/graphs/contributors
...
mission_statement_link: https://github.com/chipsalliance/Surelog/blob/master/README.md
